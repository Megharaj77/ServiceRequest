...
public class SRDetailsDto4 {
	...
	public SRDetailsDto4() {
		super();
	}


	public SRDetailsDto4(Integer reqId, Integer userId, RequestType requestType, Date requestedDate, Date assignedDate,
